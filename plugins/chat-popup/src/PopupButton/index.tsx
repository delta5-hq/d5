...
export default function PopupButton({
  ...
  function handleClick(): void {
    ...
    localStorage.setItem(`deltafive-has-interacted-${configuration.token}`, "true")
  }
  ...
  return (
    <>
      ...
      >
        ...
        {configuration.addUnreadDot && !hasInteracted && isCollapsed && (
          <div
      ...
      {configuration.popupMessage && !hasInteracted && isCollapsed && (
        <div
        ...
        >
          ...
          />
          <button className="deltafive-small-btn" onClick={() => handleMessageCloseClick()}>
