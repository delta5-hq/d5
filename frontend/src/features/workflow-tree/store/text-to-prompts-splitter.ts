...
// Outlining algorithm mirrors backend/src/controllers/commandExecutor/commands/utils/createNodes.js
// `linesToNodes`. A shared module is not worth the cross-runtime build cost for ~40 lines;
// the parity test suite in __tests__/text-to-prompts-splitter.test.ts guards against silent drift.
