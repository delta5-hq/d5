...
const DropdownMenuTrigger = ({ ...props }: React.ComponentProps<typeof DropdownMenuPrimitive.Trigger>) => (
  <DropdownMenuPrimitive.Trigger
    className="focus-visible:ring-blue-400 focus-visible:ring-[3px] cursor-pointer"
...
const DropdownMenuItem = ({
  ...
  <DropdownMenuPrimitive.Item
    className={cn(
      'active-animated rounded-sm focus:[background:linear-gradient(to_right,var(--primary)_10%,var(--primary-gradient-end))] focus:text-accent-foreground',
      'data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10',
      'dark:data-[variant=destructive]:focus:bg-destructive/20 data-[variant=destructive]:focus:text-destructive',
      "data-[variant=destructive]:*:[svg]:!text-destructive [&_svg:not([class*='text-'])]:text-muted-foreground relative",
      'flex cursor-pointer items-center gap-2 px-2 py-1.5 text-sm outline-hidden select-none',
