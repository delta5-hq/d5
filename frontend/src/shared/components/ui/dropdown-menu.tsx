...
const DropdownMenuItem = ({
  ...
  <DropdownMenuPrimitive.Item
    className={cn(
      'active-animated focus:bg-accent focus:text-accent-color',
      ...
      'flex cursor-pointer items-center gap-2 rounded-none px-2 py-1.5 text-sm outline-hidden select-none',
