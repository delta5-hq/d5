...
if (typeof window !== 'undefined') {
  ...
  window.TgsAnimations.push({ id: 'eyes-blink', data: animationData });
  
  /* Auto-init only if container exists */
  const container = document.getElementById('eyes-blink');
  if (container) {
    const player = new TgsPlayer(animationData, 'eyes-blink');
