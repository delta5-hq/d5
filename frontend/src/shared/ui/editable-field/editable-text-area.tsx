...
export interface EditableTextAreaHandle {
  startEditing: () => void
}
...
export const EditableTextArea = forwardRef<EditableTextAreaHandle, EditableTextAreaProps>(
  (
    { value, onChange, displayValue, placeholder, className, editClassName, autoFocus, readOnlyClassName, title },
    ref,
  ) => {
