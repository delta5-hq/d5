...
>(({ className, ...props }, ref) => <AlertDialogPrimitive.Action className={cn(className)} ref={ref} {...props} />)
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel className={cn('mt-2 sm:mt-0', className)} ref={ref} {...props} />
))
